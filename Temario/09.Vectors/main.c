...
void inicialitzarTotVector(int num[],int totalElements);
void pintarVector(int num[],int totalElements);
...
int main() {
    ...
    inicialitzarTotVector(num,MAXVECTOR);
    pintarVector(num,MAXVECTOR);
