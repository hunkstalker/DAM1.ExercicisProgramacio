...
int posicioVector(int v[], int qttE, int num);
void imprimirVector(int v[], int qttE);
void imprimir2Vectors(int v1[], int v2[], int qttE);
void randomIn(int v[], int num, int maxim);
void marcaVector(int v[], int qttE);
float avgVector(int v[], int qttE);
...
/// Devuelve la posición de un valor en el vector. posicioVector(nombreVector, cantidadElementos, numeroEncontrar).
int posicioVector(int v[], int qttE, int num) {
    int i=0;
    int pos=-1;
...
/// Imprime posición y valor partiendo de 1 vector. imprimirVector(nombreVector, cantidadElementos).
void imprimirVector(int v[], int qttE){
    int i=0;
    for (;i<qttE;i++){
        if (v[i]!=-1){
...
/// Imprime la posición y valor partiendo de 2 vectores. imprimir2Vectors(nombreVector, contadorPosicion, cantidadElementos).
void imprimir2Vectors(int v1[], int v2[], int qttE){
    int i=0;
    if (qttE==0){
