...
/// Dossier 2020-21-ME-UF1. Tema 3.0 Exercici 04
...
int main()
{
    SetConsoleTitle("Dossier Tema 3.0 Exercici 04. (NotaNumericaaLLetres5) Denis Anfruns.");
    ...
    setColor(6); preguntaArray(strcpy(qstPhrase,"\n >> Dossier Tema 3.0 Exercici 04. (NotaNumericaaLLetres5) Denis Anfruns."));
//    timer(); // Experimento
